...
package com.langf.efence.devicelist.camera;
...
import com.langf.efence.devicelist.scan.PreferencesActivity;
...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        if (width < height) {
            Logger.d("Display reports portrait orientation; assuming this is incorrect");
            int temp = width;
            width = height;
            height = temp;
        }
        ...
        Logger.d("Screen resolution: " + screenResolution);
        cameraResolution = findBestPreviewSizeValue(parameters, screenResolution, false);
        Logger.d("Camera resolution: " + cameraResolution);
    }
    ...
    private static String findSettableValue(Collection<String> supportedValues, String... desiredValues) {
        Logger.d("Supported values: " + supportedValues);
        String result = null;
        ...
        Logger.d("Settable value: " + result);
        return result;
    }
